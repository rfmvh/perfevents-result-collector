...
parser.add_argument("--experiment-A", action="append")
parser.add_argument("--experiment-B", action="append")
...
if __name__ == "__main__":
    compare(
        ...
        A__experiments__name=options.experiment_A,
        B__experiments__name=options.experiment_B
    )
